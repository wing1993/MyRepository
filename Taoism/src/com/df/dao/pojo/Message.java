...
public class Message  implements java.io.Serializable {
    ...
    /** full constructor */
    public Message(String author, String publishTime, String messageContent, String con1, String con2, String con3, String con4, String con5) {
        this.author = author;
        this.publishTime = publishTime;
        this.messageContent = messageContent;
        this.con1 = con1;
    ...
    public String getPublishTime() {
        return new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(this.publishTime);
    }
    
    public void setPublishTime(String publishTime) {
        this.publishTime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(this.publishTime);
    }
