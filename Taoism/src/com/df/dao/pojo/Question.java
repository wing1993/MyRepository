...
public class Question implements java.io.Serializable {
	...
	/** minimal constructor */
	public Question(String username, String QTime, String QTypeName,
			String askWho, String QTitle, String QContent, Integer state,
			String sharezone, Integer shareState) {
	...
	public Question(String username, String QTime, String QTypeName,
			String askWho, String QTitle, String QContent, Integer state,
			Integer visits, String sharezone, Integer shareState, String con1,
			String con2, String con3, String con4, String con5, String con6,
			String con7, Set replies) {
		this.username = username;
		this.QTime = QTime;
		this.QTypeName = QTypeName;
		this.askWho = askWho;
